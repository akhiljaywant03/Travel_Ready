...
public class registerRFID extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String finalCard = SaveManCard;
        Log.i("TAG", "finalCard: " +finalCard);
        results.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(registerRFID.this,rfid_card_details.class);
                intent.putExtra("RFIDNo", finalCard);
                view.getContext().startActivity(intent);
            }
        });
