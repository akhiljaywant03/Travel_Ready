...
public class ScannerqrcodeActivity extends AppCompatActivity {
    ...
    private void initComponents() {
        textViewBarCodeValue = findViewById(R.id.txtQRcodeValue);
    ...
    private void setBarCode(final SparseArray<Barcode> barCode){
        textViewBarCodeValue.post(new Runnable() {
            ...
            public void run() {
                ...
                Intent intent = new Intent(ScannerqrcodeActivity.this, registerRFID.class);
                intent.putExtra("cardDetails",intentData);
                myPrefs = getSharedPreferences("prefID", Context.MODE_PRIVATE);
                SharedPreferences.Editor editor = myPrefs.edit();
                editor.putString("nameKey", intentData);
                editor.apply();
